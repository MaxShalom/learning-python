...
# For those of you using wierd fonts, that is a lowercase L, not a number one. This counts the number of l's in the string. Therefore, it should print 3.
...
# The below causes the string to b=change the case of the letters.

astring = "Hello world!"
print(astring.upper()) # Makes all letters UPPERCASE

print(astring.lower()) # Makes all letters lowercase

astring = "Hello world!"
print(astring.startswith("Hello"))
print(astring.endswith("asdfasdfasdf"))

# The above is used to determine whether the string starts with something or ends with something, respectively. The first one will print True, as the string starts with "Hello". The second one will print False, as the string certainly does not end with "asdfasdfasdf".
